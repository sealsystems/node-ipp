...
// @ts-expect-error ts-migrate(2542) FIXME: Index signature in type 'String' only permits read... Remove this comment to see the full error message
...
// @ts-expect-error ts-migrate(2542) FIXME: Index signature in type 'String' only permits read... Remove this comment to see the full error message
status[0x0420] = 'client-error-not-fetchable'; // http://ftp.pwg.org/pub/pwg/candidates/cs-ippinfra10-20150619-5100.18.pdf     did not get standardized
